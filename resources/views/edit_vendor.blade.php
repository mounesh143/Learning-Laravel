...
<div class="container">
  ...
  {{csrf_field()}}
    <div class="control-group">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" id="Vendor Id:" required value="{{$vendors->vendor_id}}">
      </div>
    </div>
	<div class="form-group">
      <label class="form-label col-sm-2" for="Vendor Id Display">Vendor Id Display:</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" name="vendor_id_display" value="{{$vendors->vendor_id_display }}" id="Vendor Id Display" max="10" required>
      </div>
    </div>
	...
	<div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="number" class="form-control" id="Phone Number" value="{{$vendors->phone_number }}" placeholder="Enter Phone Number" name="phone_number" required>
      </div>
    </div>
 	<div class="control-group">
      <label class="form-label col-sm-2" for="Whatsapp Number">Whatsapp Number:</label>
      <div class="col-sm-3">
        <input type="number" class="form-control" id="Whatsapp Number" value="{{$vendors->whatsapp_number }}" placeholder="Enter Whatsapp Number" name="whatsapp_number" required>
      </div>
    </div>
	<div class="form-group">
      <label class="form-label col-sm-2" for="Whatsapp Number">Contact Name:</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="Contact Name"  value="{{$vendors->contact_name }}"placeholder="Enter Contact Name" name="contact_name" required>
      </div>
    </div>
	<div class="control-group">
      <label class="form-label col-sm-2" for="Bill Name">Bill Name:</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="Bill Name" value="{{$vendors->bill_name }}" placeholder="Enter Bill Name" name="bill_name" required>
      </div>
    </div>
	<div class="form-group">
